...
def load_pdf(pdf_path):
    ...
    doc.close()                     # close AFTER the loop
...
def extract_financial_figures(text_by_page):
    ...
    for field, pattern in patterns.items():
        ...
        if match:
            ...
            if not value_str:          # ✅ skip if empty string
                continue
            ...
            try:
                ...
                continue              # ✅ skip bad matches instead of crashing
...
if __name__ == "__main__":
    print("=== Financial Document Intelligence Pipeline ===\n")
    load_pdf(PDF_PATH)
